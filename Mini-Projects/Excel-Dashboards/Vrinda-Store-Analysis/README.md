...
This project focuses on analyzing the annual sales data of Vrinda Store for the year 2022. The goal is to uncover meaningful patterns, customer behavior, and business trends that can support data-driven decision-making.
...
* Created calculated columns and pivot tables
* Structured dataset for analysis and visualization
...
![Orders vs Sales](images/orders_vs_sales_trend.png)
...
* Strengthen partnerships with Amazon and Myntra

---

## 📌 Conclusion

Vrinda Store’s performance in 2022 was driven by strong female customer engagement, early-year demand, and efficient order fulfillment. The business shows high potential for growth by focusing on key regions and platforms.
